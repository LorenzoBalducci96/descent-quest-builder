function setImage(elmnt){
    if(appType == "web"){ //if web app, has the base64 images
        if(elmnt.getAttribute("orientation") == "90"){
            rotateBase64Image90deg(router(elmnt.getAttribute("set"), elmnt.getAttribute("image"), "0"), true, elmnt)
                   
        }else if(elmnt.getAttribute("orientation") == "180"){
            rotateBase64Image180deg(router(elmnt.getAttribute("set"), elmnt.getAttribute("image"), "0"), elmnt)
            
        }else if(elmnt.getAttribute("orientation") == "270"){
            rotateBase64Image90deg(router(elmnt.getAttribute("set"), elmnt.getAttribute("image"), "0"), false, elmnt)
