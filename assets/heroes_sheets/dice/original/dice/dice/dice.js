...
(function(dice) {
    ...
    this.create_dice_materials_red = function(face_labels, size, margin) {
        function create_text_texture_red(text, color, back_color) {
        ...
        for (var i = 0; i < face_labels.length; ++i)
            materials.push(new THREE.MeshPhongMaterial($t.copyto(this.material_options,
                        { map: create_text_texture_red(face_labels[i], this.label_color, this.dice_color) })));
        return materials;
    }
    ...
    this.dice_face_range = { 'd4': [1, 6], 'd6': [1, 6], 'd8': [1, 6], 'd10': [1, 6], 
        'd12': [1, 6], 'd20': [1, 6], 'd100': [1, 6] };
    this.dice_mass = { 'd4': 300, 'd6': 300, 'd8': 300, 'd10': 300, 'd12': 300, 'd20': 300, 'd100': 300};
    this.dice_inertia = { 'd4': 13, 'd6': 13, 'd8': 13, 'd10': 13, 'd12': 13, 'd20': 13, 'd100': 13 };
    ...
    this.create_d8 = function() {
        if (!this.d8_geometry) this.d8_geometry = this.create_d6_geometry(this.scale);
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
