...
(function(dice) {
    ...
    this.create_dice_materials_red = function(face_labels, size, margin) {
        function create_text_texture(text, color, back_color) {
            ...
            if(text == '1'){
                ...
                context.fillText("X", canvas.width / 2, 94);
                ...
                context.fillStyle = "#ffffff"//color;
                context.fillText("2", canvas.width / 4, canvas.height / 5);

                context.font = "22px Arial";
                
                context.fillText("❤", canvas.width - 54, 32);
                context.fillText("❤", canvas.width - 54, 56);

                context.font = "36px Arial";
                context.fillText("🗲", 26, 70);
                ...
                context.textBaseline = "top";
                context.fillStyle = "#ffffff"//color;
                context.fillText("3", canvas.width / 4, canvas.height / 5);
                ...
                context.textBaseline = "top";
                context.fillStyle = "#ffffff"//color;
                context.fillText("4", canvas.width / 4, canvas.height / 5);
                ...
                context.textBaseline = "top";
                context.fillStyle = "#ffffff"//color;
                context.fillText("5", canvas.width / 4, canvas.height / 5);
                context.font = "22px Arial";
                context.fillText("❤", canvas.width - 54, 32);
                var texture = new THREE.Texture(canvas);
                texture.needsUpdate = true;
                ...
                context.textBaseline = "top";
                context.fillStyle = "#ffffff"//color;
                context.fillText("6", canvas.width / 4, canvas.height / 5);
                context.font = "22px Arial";
                context.fillText("❤", canvas.width - 54, 32);
                context.font = "36px Arial";
                context.fillText("🗲", 26, 70);
    ...
    this.create_dice_materials_blue = function(face_labels, size, margin) {
        function create_text_texture(text, color, back_color) {
            if (text == undefined) return null;
            var canvas = document.createElement("canvas");
            var context = canvas.getContext("2d");
    ...
    /*
    this.known_types = ['d6', 'd6', 'd6', 'd6', 'd6', 'd6', 'd6'];
    ...
    */
   this.known_types = ['dblue', 'dred', 'dyellow', 'dgreen', 'dbrown', 'dgrey', 'dblack'];
   this.dice_face_range = { 'dblue': [1, 6], 'dred': [1, 6], 'dyellow': [1, 6], 'dgreen': [1, 6], 
       'dbrown': [1, 6], 'dgrey': [1, 6], 'dblack': [1, 6] };
   this.dice_mass = { 'dblue': 300, 'dred': 300, 'dyellow': 300, 'dgreen': 300, 'dbrown': 300, 'dgrey': 300, 'dblack': 300 };
   this.dice_inertia = { 'dblue': 13, 'dred': 13, 'dyellow': 13, 'dgreen': 13, 'dbrown': 13, 'dgrey': 13, 'dblack': 13 };
    ...
    this.create_dred = function() {
        ...
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials_red(this.standart_d20_dice_face_labels, this.scale / 2, 1.0));
        return new THREE.Mesh(this.d6_geometry, this.dice_material);
    }

    this.create_dblue = function() {
        if (!this.d6_geometry) this.d6_geometry = this.create_d6_geometry(this.scale * 0.9);
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials_blue(this.standart_d20_dice_face_labels, this.scale / 2, 1.0));
        return new THREE.Mesh(this.d6_geometry, this.dice_material);
    }

    this.create_dyellow = function() {
        if (!this.d6_geometry) this.d6_geometry = this.create_d6_geometry(this.scale * 0.9);
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials_red(this.standart_d20_dice_face_labels, this.scale / 2, 1.0));
        return new THREE.Mesh(this.d6_geometry, this.dice_material);
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        //TODO
        let colors = ["blue", "red", "yellow", "green", "brown", "grey", "black"];
